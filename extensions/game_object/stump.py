...
class Stump(GameObject):
    def __init__(self,
        ...
        self.init_image()
    def init_image(self):
        self.base = img_manager.load_image("data/sprites/trunk/StumpBase.png")
        self.top = img_manager.load_image("data/sprites/trunk/StumpTop.png")
        self.fill = img_manager.load_image("data/sprites/trunk/StumpFill.png")
